...
//fill background
        ...
        g.setColor(Color.white);
        g.fillRect(200, 100, 500, 100);
        g.fillRect(400, 50, 750, 100);
        ...
        drawTree(250,500,0,15,15);
        drawTree(400,510,0,15,15);
        drawBanner(460,575,0,15,15);
        
        drawPerson(475,520,0,7,7);
        drawPerson(515,520,0,7,7);
        drawPerson(547,520,0,7,7);
        drawPerson(650,520,0,7,7);
        drawStand(650,530,0,7,7);
        
        drawTree( 1150,505,0,15,15);
        drawTarget(1100,525,0,7,7);
        drawTree(400,708,0,15,15);
        drawTree(700,725,0,15,15);
        drawTree(150,625,0,15,15);
        drawTree(850,625,0,15,15);
        
        drawBow(725,520,0,6,6);
        drawArrow(725,520,0,6,6);
    ...
    public void drawBanner(int xpos,int ypos,double rot,double xscale,double yscale)
    {
        ...
        g.setColor(Color.GRAY);//textbehind
        int xval1[] = { 1,1,8,8,1};
        int yval1[] = { -8,-6,-6,-8,-8};
        g.fillPolygon(xval1,yval1,xval1.length);
